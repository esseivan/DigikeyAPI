...
namespace ApiClient.Constants
{
    ...
    public static class DigiKeyUriConstants
    {
        ...
        private static readonly Uri TokenEndpoint_SB = new Uri(
            "https://sandbox-api.digikey.com/v1/oauth2/token"
        );
        private static readonly Uri AuthorizationEndpoint_SB = new Uri(
        ...
        private static readonly Uri TokenEndpoint_PROD = new Uri(
            "https://api.digikey.com/v1/oauth2/token"
        );
        private static readonly Uri AuthorizationEndpoint_PROD = new Uri(
